...
We report seed-level variance but not formal significance tests; the paper relies on locked decision rules, replicated seeds, and cross-protocol consistency rather than confidence intervals or hypothesis tests.
