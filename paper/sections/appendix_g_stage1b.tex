...
\begin{table}[h]
\centering
\caption{Cube full projected CEM across representative dimensions.  This
main sweep uses 25 pairs and projection seed~0; the anomaly sanity check
repeated the $m=32$ versus $m=192$ comparison across three seeds.}
...
$m$ & $\Rendpoint$ & $\Rpool$ & $\DeltaCEM$ & $M_{\text{rank1}}$ (\%) & Pool success (\%) \\
\midrule
1 & 0.238 & 0.003 & 0.235 & 44.0 & -- \\
8 & 0.477 & 0.030 & 0.447 & 64.0 & -- \\
32 & 0.570 & 0.011 & 0.559 & 76.0 & -- \\
64 & 0.575 & 0.006 & 0.569 & 72.0 & 78.4 \\
192 & 0.603 & 0.008 & 0.595 & 60.0 & -- \\
\bottomrule
\end{tabular}
\end{table}

Cube full projected CEM shows an inverted-U success pattern, peaking at
$m=32$ (76.0\%) and then declining to 60.0\% at $m=192$.  This
non-monotonicity contrasts with PushT's monotonic rise and was classified
as MIXED in the closeout because the main sweep uses only 25 pairs and
seed~0.  The Cube anomaly sanity check found that the $m=32$ versus
$m=192$ gap remains positive at +5.33 percentage points across three seeds,
while $\Rpool$ stays near zero throughout.
...
\midrule
Invisible quadrant & Full proj. & 0.375 & 0.010 & 0.365 & 4.2 & -- \\
...
Ordinary & Full proj. & 0.457 & 0.194 & 0.263 & 86.7 & -- \\
