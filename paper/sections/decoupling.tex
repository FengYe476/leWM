...
\midrule
$\Cmodel$ (predicted latent) & 0.084$\pm$0.243 & [0.037, 0.131] & End-to-end predictor, encoder, and latent cost shape \\
...
$C_\mathrm{V1}$ (physical hinge) & 0.666$\pm$0.357 & [0.595, 0.735] & Physical ground-truth ranker on the same pool \\
\bottomrule
\end{tabular}
}
