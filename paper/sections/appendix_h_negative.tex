...
64 & 72.0 & 60.0 & 72.0 & 68.0 \\
192 & 60.0 & 64.0 & 72.0 & 65.3 \\
\bottomrule
\end{tabular}
\end{table}

The $m=32$ advantage persists across seeds but with high variance, including
a seed-level range of 12 percentage points at $m=32$.  The closeout
classified this as MIXED under the pre-registered 5--10 percentage-point
criterion, and Cube entered the final paper as supplementary rather than
primary evidence.
