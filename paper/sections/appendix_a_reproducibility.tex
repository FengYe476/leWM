...
Face snapshot revision is not pinned in the repository:
\texttt{[TO BE FILLED: Hugging Face revision or snapshot hash for each checkpoint]}.
...
\input{../docs/revision/appendix_uncertainty_table.tex}
