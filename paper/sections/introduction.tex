...
Beyond diagnosis, the V3 decomposition points to a concrete intervention: Section~\ref{sec:warp_ensemble} shows that a lightweight learned calibration of the local latent geometry, trained on pool-level ranking labels, can partially recover the lost selection quality without modifying the CEM search process.
